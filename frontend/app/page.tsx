  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 text-cyan-50 font-mono relative overflow-hidden select-none">
      ...
      <main className="relative z-10 flex flex-col items-center text-center p-8 max-w-4xl w-full">
        ...
        {/* Status Panels */}
        <div className={`mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl transition-all duration-1000 delay-500 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>

          <div className="bg-slate-900/50 border border-cyan-500/10 p-4 rounded backdrop-blur-sm">
            <h3 className="text-cyan-500/70 text-xs uppercase tracking-widest mb-1">Status</h3>
          ...
          <div className="bg-slate-900/50 border border-cyan-500/10 p-4 rounded backdrop-blur-sm">
            <h3 className="text-cyan-500/70 text-xs uppercase tracking-widest mb-1">Target</h3>
          ...
          <div className="bg-slate-900/50 border border-cyan-500/10 p-4 rounded backdrop-blur-sm">
            <h3 className="text-cyan-500/70 text-xs uppercase tracking-widest mb-1">Version</h3>
            <div className="text-cyan-100 font-bold">
              v2.5.0 STABLE
            </div>
          </div>
